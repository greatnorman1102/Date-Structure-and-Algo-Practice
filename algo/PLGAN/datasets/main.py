...
#            map_current.GenPatchInLoop(patch_row_idx, patch_col_idx, count)
		# Generate building permittivity 3D tensor
		urbanTensor, receiveTensor, idx, site_locations, bs_params, patch_row_idx_temp, patch_col_idx_temp = map_current.GenTensorInLoop(patch_row_idx, patch_col_idx, count, saveTensor=True)
